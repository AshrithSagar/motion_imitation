...
def imitation_terminal_condition(
    env, dist_fail_threshold=1.0, rot_fail_threshold=0.5 * np.pi
):
    ...
    root_pos_fail = (
        root_pos_diff.dot(root_pos_diff) > dist_fail_threshold * dist_fail_threshold
    )
