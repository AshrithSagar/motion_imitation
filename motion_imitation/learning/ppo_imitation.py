...
from stable_baselines.common import (ActorCriticRLModel, Dataset, SetVerbosity,
                                     TensorboardWriter, explained_variance,
                                     fmt_row, zipsame)
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    clip_frac = tf.reduce_mean(
                        tf.to_float(tf.greater(tf.abs(ratio - 1.0), clip_param))
                    )
