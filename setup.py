...
if _platform == "linux" or _platform == "linux2":
    ...
    os.environ["LDFLAGS"] = (
        "-framework Cocoa -mmacosx-version-min=10.7 -stdlib=libc++ -framework OpenGL"
    )
...
setup(
    ...
    version="0.0.6",
    description="Motion Imitation and MPC with python bindings for MPC using the osqp solver",
    long_description="Motion Imitation and MPC with python bindings for MPC using the PyBullet and the QPOASES and OSQP solver",
