...
class SimpleRobot(object):
    def __init__(self, pybullet_client, robot_uid, simulation_time_step):
        ...
        self._motor_offset = np.array(
            [0.0, -0.6, 0.66, 0.0, -0.6, 0.66, 0.0, -0.6, 0.66, 0.0, -0.6, 0.66]
        )
    ...
    def GetMotorPositionGains(self):
        return [220.0] * self.num_motors

    def GetMotorVelocityGains(self):
        return np.array([1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0, 1.0, 2.0, 2.0])
